...
# Build and push
docker buildx build --platform linux/386,linux/amd64,linux/arm64/v8,linux/arm/v6,linux/arm/v7,linux/ppc64le,linux/s390x -t spurin/funbox:latest . --push

# Update local image
docker pull spurin/funbox:latest
